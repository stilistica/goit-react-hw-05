...
const API_KEY = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJmMDE4YTIyMmY0NTU2OTEwYzRhNzVmYWIwMzA0ZjU1YyIsIm5iZiI6MTc0NDgwOTEyMi4wMzUsInN1YiI6IjY3ZmZhY2EyYzc3ZmQxZGY3NGFjZWE0MiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.0_IT9HPvNl1DQtX0Rr7D0_pwIX9V4gy4XLolz1QGkyM'
const options = {
    headers: {
...
export const fetchTrendingMovie = async (page, signal) => {
    const response = await axios.get(`https://api.themoviedb.org/3/trending/movie/day?language=en-US&page=${page}`,
        {
            ...options,
            signal
        }
